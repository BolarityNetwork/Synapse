...
use crate::getters::get_relayer_ncn_config;
...
pub struct KeeperState {
    ...
    pub relayer_ncn_config_address: Pubkey,
...
impl KeeperState {
    pub async fn fetch(&mut self, handler: &CliHandler, epoch: u64) -> Result<()> {
        ...
        //     BaseRewardReceiver::find_program_address(&handler.relayer_ncn_program_id, &ncn, epoch);
