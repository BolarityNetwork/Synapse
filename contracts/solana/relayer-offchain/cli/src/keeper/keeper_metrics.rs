...
use relayer_ncn_core::{
    // account_payer::AccountPayer, base_fee_group::BaseFeeGroup,
...
use crate::{
    getters::{
        ...
        // get_base_reward_receiver, get_base_reward_router,
        get_current_epoch_and_slot,
        get_epoch_snapshot,
        // get_epoch_state, get_is_epoch_completed,
        // get_ncn_reward_receiver, get_ncn_reward_router,
        get_operator, get_operator_snapshot,
        get_relayer_ncn_config,
        get_vault, get_vault_operator_delegation,
        get_vault_registry,
        get_weight_table,
    },
    handler::CliHandler,
...
pub async fn emit_ncn_metrics_config(handler: &CliHandler) -> Result<()> {
    ...
    let config = get_relayer_ncn_config(handler).await?;
