...
pub struct Args {
    ...
    #[arg(
        long,
        global = true,
        env = "RELAYER_NCN_PROGRAM_ID",
        default_value_t = relayer_ncn_program::id().to_string(),
        help = "Relayer ncn program ID"
    )]
    pub relayer_ncn_program_id: String,
    ...
    #[arg(
        long,
        global = true,
        env = "RELAYER_HUB_PROGRAM_ID",
        default_value_t = relayer_hub_sdk::relayer_hub::ID.to_string(),
        help = "Relayer hub program ID"
    )]
    pub relayer_hub_program_id: String,
...
impl fmt::Display for Args {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        ...
        // Program IDs
        writeln!(f, "\n🔑 Program IDs:")?;
        writeln!(f, "  • Relayer ncn:        {}", self.relayer_ncn_program_id)?;
