...
impl From<RelayerNcnError> for ProgramError {
    fn from(e: RelayerNcnError) -> Self {
        Self::Custom(e as u32)
    }
}

impl From<RelayerNcnError> for u64 {
    fn from(e: RelayerNcnError) -> Self {
        e as Self
    }
}

impl From<RelayerNcnError> for u32 {
    fn from(e: RelayerNcnError) -> Self {
        e as Self
    }
}
