...
use crate::{error::RelayerNcnError, vault_registry::StMintEntry};
...
impl WeightEntry {
    ...
    pub fn precise_weight(&self) -> Result<PreciseNumber, RelayerNcnError> {
        PreciseNumber::new(self.weight.into()).ok_or(RelayerNcnError::NewPreciseNumberError)
    }
