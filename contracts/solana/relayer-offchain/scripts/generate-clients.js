...
const rustWeightTableClientDir = path.join(rustClientsDir, "relayer_ncn");
const jsWeightTableClientDir = path.join(jsClientsDir, "relayer_ncn");
const weightTableRootNode = anchorIdl.rootNodeFromAnchor(require(path.join(idlDir, "relayer_ncn_program.json")));
