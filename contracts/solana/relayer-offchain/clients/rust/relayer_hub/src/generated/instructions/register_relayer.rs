...
impl RegisterRelayer {
  ...
  pub fn instruction_with_remaining_accounts(&self, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let data = RegisterRelayerInstructionData::new().try_to_vec().unwrap();
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct RegisterRelayerInstructionData {
            discriminator: [u8; 8],
      }

impl RegisterRelayerInstructionData {
  pub fn new() -> Self {
    Self {
                        discriminator: [98, 213, 0, 0, 27, 134, 109, 48],
                  }
  }
}

impl Default for RegisterRelayerInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
/// Instruction builder for `RegisterRelayer`.
///
/// ### Accounts:
///
                      ///   0. `[writable, signer]` payer
          ///   1. `[]` config
                ///   2. `[writable]` relayer_info
                ///   3. `[writable]` relayer
                ///   4. `[optional]` system_program (default to `11111111111111111111111111111111`)
#[derive(Clone, Debug, Default)]
pub struct RegisterRelayerBuilder {
...
#[inline(always)]
  ...
  /// `register_relayer` CPI accounts.
  pub struct RegisterRelayerCpiAccounts<'a, 'b> {
                  /// Owner of relayer.
...
/// `register_relayer` CPI instruction.
pub struct RegisterRelayerCpi<'a, 'b> {
...
impl<'a, 'b> RegisterRelayerCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_program::account_info::AccountInfo<'a>,
          accounts: RegisterRelayerCpiAccounts<'a, 'b>,
          ) -> Self {
    Self {
      __program: program,
...
/// Instruction builder for `RegisterRelayer` via CPI.
///
/// ### Accounts:
///
                      ///   0. `[writable, signer]` payer
          ...
          ///   4. `[]` system_program
#[derive(Clone, Debug)]
pub struct RegisterRelayerCpiBuilder<'a, 'b> {
  instruction: Box<RegisterRelayerCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> RegisterRelayerCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(RegisterRelayerCpiBuilderInstruction {
      __program: program,
              payer: None,
              config: None,
              relayer_info: None,
...
#[inline(always)]
  ...
  #[allow(clippy::vec_init_then_push)]
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
        let instruction = RegisterRelayerCpi {
...
#[derive(Clone, Debug)]
struct RegisterRelayerCpiBuilderInstruction<'a, 'b> {
